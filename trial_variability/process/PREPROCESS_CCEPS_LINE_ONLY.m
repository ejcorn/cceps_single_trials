function data_proc = PREPROCESS_CCEPS_LINE_ONLY(out,data,demean)
...
if ~all(isnan(data))
    ...
    prestim_data = FILTER_CCEPS_LINE_ONLY(prestim_data,out.other.stim.fs); 
    poststim_data = FILTER_CCEPS_LINE_ONLY(poststim_data,out.other.stim.fs);%,[],[],data_mean);
